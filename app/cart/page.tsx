...
import { ArrowRight, Heart, ImageSquare, Minus, Plus, ShoppingCartSimple, Trash } from "@phosphor-icons/react";
import { useEffect, useMemo, useState } from "react";
import { SiteChrome } from "../components/site-chrome";
import { readCart, writeCart } from "../lib/commerce";

export type CartItem = { id: string; title: string; price: number; quantity: number; image: string | null; detail: string };
